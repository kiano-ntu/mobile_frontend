class Product {
  ...
  String getMainImageUrl() {
    ...
    if (gambarProduk.contains(',')) {
      ...
      return 'http://192.168.213.124:8000/storage/products/$firstImage';
    }

    return 'http://192.168.213.124:8000/storage/products/${gambarProduk.trim()}';
  }
    ...
    if (gambarProduk.contains(',')) {
      ...
      for (String name in imageNames) {
        ...
        if (trimmedName.isNotEmpty) {
          images.add('http://192.168.213.124:8000/storage/products/$trimmedName');
        }
      }
    } else {
      // Single image
      images.add('http://192.168.213.124:8000/storage/products/${gambarProduk.trim()}');
    }
